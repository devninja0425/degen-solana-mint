...
import { STAKE_DATA_SIZE, STAKE_CONTRACT_IDL, CANDY_MACHINE_CONTRACT_IDL } from '../consts/contract';
import { NEXT_PUBLIC_SOLANA_RPC_HOST, NEXT_PUBLIC_STAKE_CONTRACT_ID, NEXT_PUBLIC_STAKE_POOL_ID, NEXT_PUBLIC_TOKEN_PROGRAM_ID } from '../consts/env';
...
export const getNFTs = async (wallet, connection, transactionSet) => {
    ...
    let provider = new anchor.Provider(connection, wallet, confirmOption)
    let program = new anchor.Program(CANDY_MACHINE_CONTRACT_IDL, NEXT_PUBLIC_TOKEN_PROGRAM_ID, provider)
