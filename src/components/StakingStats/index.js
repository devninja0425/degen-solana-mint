...
import './style.css'
 ...
 const StakingStats = ({stakedNfts, totalStaked, claimAmount, dailyRewardAmount, floorPrice}) => {
  return(
    <>
        ...
        <div className='statkingstatsborderbox'>
          ...
          <div className='stakingstatsNumArea'>
            ...
            <div className='stakingstastextarea'>
              <p  className='stakingstatsNum'><StakingLockedValue text={(totalStaked * floorPrice).toFixed(2)} /></p>
      ...
      <div className='stakingbar'>
        <div className='statkingstatsborderbox'>
          ...
          <div className='stakingstatsNumArea row'>
            ...
            <div className='col'>
              <p  className='stakingstatsNum'><StakingSweepers text={5} /></p>
